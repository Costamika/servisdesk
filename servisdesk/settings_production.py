...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure--*y6-5=0wt@o_2m206s1w(y3tu6@8lhscpwcm(#9$op!i%by&@')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '192.168.0.149,localhost,127.0.0.1').split(',')
